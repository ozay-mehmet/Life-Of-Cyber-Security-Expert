...
void eglen(char *isim , int *duzey) // eglen - 8
{
    ...
    else
    {
        ...
        printf("1 - Bilgisayar oyunu oyna\t2 - Tahta oyunlari oyna\t3 - Kardesinle saklambac oyna\n");
        ...
        while(kontrol == 1) // kod
        {
            ...
            {
                kontrol = 2;
                printf("\nStratejik dusunebiliyorsan ozellikle satranc oynamani tavsiye ederim.\n");
